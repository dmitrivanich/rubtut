...
questions = [
    ...
    "Вы теперь в бешенстве?",
    "Вас кусала собака, а потом говорила 'Извини, брат, я сам не в себе, бешенством болею... тебе бы в больничку... психиатрическую...'?",
    "Да?"
    "Ну ведь Да же!?"
    ...
    "Этот вопрос никак не зависит от предыдущего, не знаю зачем его задал.Вы знаете?"
